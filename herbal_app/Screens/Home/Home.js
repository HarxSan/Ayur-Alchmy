      ...
      <ScrollView style={{flex:1}}>
        <View style={{backgroundColor:'white', flex:1, height:screenHeight}}>       
          ...
          <TouchableOpacity style={styles.tile1} onPress={() => Macroroute(navigation)} >
            <Image source={require('../icons/macronutrient.png')} style={styles.tileimg1}></Image>           
            <Text style={styles.tiletxt1}>Macro{'\n'}calculator</Text>
          ...
          <TouchableOpacity style={styles.tile3} onPress={()=>Herbsroute(navigation)}>    
            ...
            <Text style={styles.tiletxt3}>Herb{'\n'}Recommedation</Text>
          ...
          <TouchableOpacity style={styles.tile4} onPress={()=>Variousroute(navigation)}> 
            <Image source={require('../icons/cinnamon.png')} style={styles.tileimg4}></Image>                    
            <Text style={styles.tiletxt4}>Various{'\n'}Texture</Text>
